"""Scrape Great Lakes listings from Barnstormers.com and render them into
...
PAGE_TITLE = "Other Great Lakes Ads on the Web"
...
EXTERNAL_SEARCH_LINKS = [
    ("Trade-A-Plane", "https://www.trade-a-plane.com/filtered/search?s-type=aircraft&s-keyword-search=great+lakes&s-original-search=great+lakes"),
    ("Controller", "https://www.controller.com/listings?keywords=great+lakes"),
    ("ASO", "https://aso.com/search?q=Great+Lakes"),
]
...
<body>
  ...
  <div class="more-resources">
    <h2>Search More Great Lakes Listings</h2>
    <p>View additional Great Lakes Aircraft listings at these fine sites:</p>
